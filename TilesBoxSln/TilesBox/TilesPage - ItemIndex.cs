...
namespace TilesBox
{
    public partial class TilesPage : ContentControl
    {
        ...
        protected static void SetItemIndex(TilesPageItem tile, int index)
        {
            tile.SetValue(ItemIndexPropertyKey, index);
        }

        /// <summary><see cref="DependencyPropertyKey"/> для <see cref="SetTileType(TilesPageItem, TileTypeContentEnum?)"/>.</summary>
        protected static readonly DependencyPropertyKey ItemIndexPropertyKey =
            DependencyProperty.RegisterAttachedReadOnly(nameof(GetItemIndex).Substring(3), typeof(int?), typeof(TilesPage), new PropertyMetadata(null, ItemIndexChanged));
        /// <summary><see cref="DependencyProperty"/> для <see cref="SetTileType(TilesPageItem, TileTypeContentEnum?)"/>.</summary>
        ...
        {
            tile.ClearValue(ItemIndexPropertyKey);
        }
